...
/**
 * Provides a 'ILA Facets Block' block.
 *
 * @Block(
 *  id = "ila_facets_block",
 *  admin_label = @Translation("ILA Facets Block"),
 * )
 */
class IlaFacetsBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    $facets_to_include = [
      'facet_block:career_level' => 'facet_block:career_level',
      'facet_block:contract_type' => 'facet_block:contract_type',
    ];
