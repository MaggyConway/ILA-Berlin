...
namespace Drupal\ila_attendee_registration\Plugin\Mail;
...
/**
 * Provides a 'ILA Attendee Registration Mail' plugin to send emails.
 *
 * @Mail(
 *   id = "ila_attendee_registration_mail",
 *   label = @Translation("ILA Attendee Registration Mail"),
 *   description = @Translation("ILA Mailer Plugin.")
 * )
 * {@inheritDoc}
 */
class AttendeeRegistrationMail extends SwiftMailer {
