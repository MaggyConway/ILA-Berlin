...
namespace Drupal\ila_media_pages\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'file_image_style_formatter_link' formatter.
 *
 * @FieldFormatter(
 *   id = "file_image_style_link_formatter",
 ...
 * )
 */
class FileImageStyleLinkFormatter extends ImageFormatterBase implements ContainerFactoryPluginInterface {
  /**
   * The current user.
   *
